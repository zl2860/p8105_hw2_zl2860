...
The `percentage` is the key variable of the `unemployment` dataset. I dropped these rows with missing values of this variable because the content of the resulting merged dataset will not be changed even if I keep these rows in the original dataset.
